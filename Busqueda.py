...
def tablero(estado):
    print(estado[0], estado[3], estado[6])
    print(estado[1], estado[4], estado[7])
    print(estado[2], estado[5], estado[8])
    print("")
...
def main():
    estadoInicial = []
    for i in range(0, 9):
        estadoInicial.append(int(input('Inserta el numero ' + str(i) + ': ')))
